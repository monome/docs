...
,
		"classnamespace" : "box",
		"openrect" : [ 34.0, 100.0, 366.0, 476.0 ],
		"bglocked" : 0,
...
,
						"classnamespace" : "rnbo",
						"openrect" : [ 469.0, 100.0, 665.0, 368.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 89.0, 576.0, 216.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 55.0, 166.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.0, 11.0, 67.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 44.0, 322.0, 200.0, 23.0 ],
									"rnbo_classname" : "outport",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 55.0, 143.0, 23.0 ],
...
,
					"patching_rect" : [ 10.0, 385.0, 196.0, 22.0 ],
					"rnboattrcache" : 					{
...
,
									"fileref" : 									{
										"name" : "grid-rnbo-2-3",
										"filename" : "grid-rnbo-2-3.maxsnap",
										"filepath" : "~/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "2059441f90b51a9ddde5fdc0211e87d3"
									}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 212.0, 233.0, 187.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 113.0, 188.0, 277.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 216.0, 100.0, 187.0, 50.0 ],
									"text" : "grid LED 'set' messages are in the same format, so we can simply pass keypress data through "
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 189.0, 56.0, 183.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 44.0, 232.0, 166.0, 23.0 ],
									"rnbo_classname" : "outport",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 188.0, 67.0, 23.0 ],
									"rnbo_classname" : "loadmess",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "loadmess_obj-9",
									"rnboinfo" : 									{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 44.0, 100.0, 170.0, 23.0 ],
									"rnbo_classname" : "outport",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
,
					"patching_rect" : [ 10.0, 358.0, 196.0, 22.0 ],
					"rnboattrcache" : 					{
...
, 								{
									...
									"fileref" : 									{
										"name" : "grid-rnbo-2-1",
										"filename" : "grid-rnbo-2-1_20240611.maxsnap",
										"filepath" : "~/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "d9ecb795d080a1e06cdc11f0735fdac9"
									}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 306.0, 340.0, 20.0 ],
					"text" : "double-click each RNBO patch and export to Pi:"
				}
...
, 			{
				"box" : 				{
					...
					"bgfillcolor_angle" : 270.0,
					"bgfillcolor_autogradient" : 0.0,
					"bgfillcolor_color" : [ 0.737254901960784, 0.847058823529412, 0.709803921568627, 1.0 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 230.0, 218.0, 62.0 ],
					"text" : ";\rmax launchbrowser https://mnonome.org/docs/grid/studies/rnbo/#grid-pi",
...
,
						"classnamespace" : "rnbo",
						"openrect" : [ 469.0, 100.0, 429.0, 368.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 164.0, 173.0, 21.0 ],
									"text" : "print z state and x/y coordinate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 117.0, 125.0, 170.0, 21.0 ],
									"text" : "split z state and x/y coordinate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 96.0, 90.0, 83.0, 21.0 ],
									"text" : "x, y, z -> z, x, y"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 189.0, 57.0, 183.0, 21.0 ],
									"text" : "grid keypresses come in via OSC"
								}
...
,
					"patching_rect" : [ 10.0, 332.0, 196.0, 22.0 ],
					"rnboattrcache" : 					{
...
, 								{
									...
									"fileref" : 									{
										"name" : "grid-rnbo-2-1",
										"filename" : "grid-rnbo-2-1_20240611_1.maxsnap",
										"filepath" : "~/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "9bceec7d8b4f8a3cb413d462ce79c949"
									}
...
,
					"text" : "These patches demonstrate the basic interactions of grid + RNBO,\n\n2-1:\n- Key input and printing\n\n2-2:\n- Coupled LED output (each pressed key will light up for as long as it's held)\n\n2-3:\n- De-coupled LED output (each keypress will toggle that key's LED state)\n\nIMPORTANT: be sure to go through the 'grid + Pi' steps to monitor grid keypress output",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"name" : "grid-rnbo-2-1_20240611.maxsnap",
				"bootpath" : "~/Max 8/Snapshots",
				"patcherrelativepath" : "../../../../../../../Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
...
, 			{
				"name" : "grid-rnbo-2-1_20240611_1.maxsnap",
				"bootpath" : "~/Max 8/Snapshots",
				"patcherrelativepath" : "../../../../../../../Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
