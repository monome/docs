...
This tutorial assumes a basic familiarity with the Python language and its programming workflow. If you're very new to Python, check out the [Python Tutorial](https://docs.python.org/3/tutorial/).
...
This tutorial was created by [Brian Crabtree](http://nnnnnnnn.org) and [Dani Derks](https://dndrks.com) for [monome.org](https://monome.org).
