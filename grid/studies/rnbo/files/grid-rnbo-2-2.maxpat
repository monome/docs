...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 178.0, 189.0, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 184.0, 336.0, 33.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 183.0, 283.0, 56.0, 23.0 ],
									"rnbo_classname" : "number~",
									"rnbo_extra_attributes" : 									{
										"interval" : 100.0,
										"initialMode" : "monitor",
...
,
											...
											"boxes" : [ 												{
													"box" : 													{
														...
														"text" : "out 2",
														"numoutlets" : 0,
														"patching_rect" : [ 123.0, 453.0, 35.0, 22.0 ],
														"numinlets" : 1,
														"id" : "obj-8"
													}
...
, 												{
													"box" : 													{
														...
														"numoutlets" : 1,
														"outlettype" : [ "" ],
														"patching_rect" : [ 720.0, 14.0, 28.0, 22.0 ],
														"numinlets" : 0,
														"id" : "obj-7"
													}
...
, 												{
													"box" : 													{
														...
														"fontsize" : 12.0,
														"outlettype" : [ "", "" ],
														"patching_rect" : [ 50.0, 103.0, 732.0, 327.0 ],
														"fontname" : "<Monospaced>",
														"numinlets" : 3,
														"fontface" : 0,
														"id" : "obj-5",
														"code" : "Data x(256);\r\nData y(256);\r\n\r\nx.poke(in3,in1); // store z in x\r\ny.poke(in3,in2); // store z in y\r\n\r\nout1 = x.peek(in1);\r\nout2 = y.peek(in2);"
													}
...
, 												{
													"box" : 													{
														...
														"text" : "out 1",
														"numoutlets" : 0,
														"patching_rect" : [ 50.0, 453.0, 35.0, 22.0 ],
														"numinlets" : 1,
														"id" : "obj-4"
													}
...
,
									...
									"patching_rect" : [ 183.0, 234.0, 35.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
